...
export default class CreateOffer extends React.Component<Props, State> {
                        ...
                        <Form className="w-50">
                            <FormGroup>
                                ...
                                <Row>
                                    ...
                                    <Col sm="4">
                                        <Button color="primary" onClick={() => this.onSetTagClick()}>
                                            Set
                                        </Button>
                                    </Col>
                                </Row>
                        ...
                        <Form className="w-50">
                            <FormGroup>
                                ...
                                <Row>
                                    ...
                                    <Col sm="4">
                                        <Button color="primary" onClick={() => this.onSetCompareClick()}>
                                            Set
                                        </Button>
                                    </Col>
                                </Row>
                    ...
                    <div className="my-4 row justify-content-center align-items-center">
                        <Form className="w-50">
                            ...
                            <SimplePairOptionsList
                                ...
                                onDeleteClick={null}
                            />
                            <Button color="primary" className="m-2 float-right" onClick={() => this.onCreateClick()}>
                                Create
                            </Button>
                        </Form>
                    </div>
    ...
    private onCreateClick() {
        ...
        this.compareRules.forEach(item => {
            console.log(CompareAction.EQUALLY, CompareAction[item.value as any]);
            throw new Error("");
            rulesMap.set(item.key, CompareAction.EQUALLY);
        });
